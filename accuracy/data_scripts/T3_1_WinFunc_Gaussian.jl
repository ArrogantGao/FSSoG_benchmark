...
CSV.write("data/Acc_T3_1_WinFunc_Gaussian.csv", DataFrame(preset = Int[], w = Int[], energy_exact = Float64[], energy_k = Float64[], abs_error = Float64[], relative_error = Float64[]))
...
for i in 1:length(w_array)
        ...
        CSV.write("data/Acc_T3_1_WinFunc_Gaussian.csv", df, append = true)
end

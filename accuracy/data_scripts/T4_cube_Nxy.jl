...
CSV.write("data/Acc_T4_cube_Nxy.csv", DataFrame(preset = Int[], N_xy = Int[], M_mid = Int[], energy_exact = Float64[], energy_k = Float64[], abs_error = Float64[], relative_error = Float64[]))

...
CSV.write("data/Acc_T3_2_Nspec_ES.csv", DataFrame(preset = Int[], N_real = Int[], energy_exact = Float64[], energy_k = Float64[], abs_error = Float64[], relative_error = Float64[]))
...
for N_real in N_real_array
    if mod(N_real[1], 2) == 1
        ...
        CSV.write("data/Acc_T3_2_Nspec_ES.csv", df, append = true)
end

...
CSV.write("data/Acc_T5_thin_Rz.csv", DataFrame(preset = Int[], R_z = Int[], gamma = Int[], energy_exact = Float64[], energy_k = Float64[], abs_error = Float64[], relative_error = Float64[]))
